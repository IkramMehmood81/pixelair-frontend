...
// Next.js App Router — proxies image to FastAPI backend
// OPTIMIZED: passes scale and face_enhance correctly to backend
...
export async function POST(req: NextRequest) {
  try {
    ...
    const scaleRaw    = formData.get('scale') ?? '2'
    ...
    // Forward to FastAPI — all params correctly forwarded
