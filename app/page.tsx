...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does PhotoGenerate.ai work on mobile phones?',  acceptedAnswer: { '@type': 'Answer', text: 'Yes — works in any modern mobile browser on iOS and Android. No app needed.' } },
  ],
}
