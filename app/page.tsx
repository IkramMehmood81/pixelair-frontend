...
import { Zap, Sparkles, Wand2, Shield, Download, ArrowRight, CheckCircle2 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative py-16 xs:py-20 sm:py-28 md:py-32 lg:py-40 bg-gradient-to-b from-background via-background to-card/30 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-6 xs:space-y-7 sm:space-y-8">
              ...
              <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight text-balance text-foreground leading-tight">
                  Transform Your
                  <span className="block bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent">Photos Instantly</span>
                </h1>
                <p className="text-sm xs:text-base sm:text-lg md:text-xl text-muted-foreground text-balance max-w-3xl mx-auto leading-relaxed font-light px-2 xs:px-0">
                  Professional-grade image enhancement powered by advanced AI. No signup required. Completely free. Your privacy is guaranteed.
                </p>
              </div>

              <div className="flex flex-col xs:flex-row items-stretch xs:items-center justify-center gap-3 xs:gap-4 pt-4 px-2 xs:px-0">
                <Button
                  asChild
                  size="lg"
                ...
                >
                  <Link href="#upload" className="flex items-center justify-center xs:justify-start gap-3">
                    Start Enhancing
            ...
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
              <StatCard value="500K+" label="Enhanced" highlight />
              <StatCard value="100%" label="Free" />
              <StatCard value="2sec" label="Average" />
                ...
                <div className="p-6 rounded-lg border border-border bg-card">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <label className="text-sm font-medium text-foreground">Upscale Scale</label>
        ...
        <GradientSection id="features">
          <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 xs:gap-5 sm:gap-6">
              <FeatureCard icon={Zap} title="Lightning Fast" description="Enhanced images in seconds. Optimized for speed without sacrificing quality." highlight />
        ...
        <GradientSection id="how-it-works">
          <div className="max-w-5xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4 xs:space-y-5 sm:space-y-6 max-w-3xl mx-auto">
              <Step number={1} title="Upload Your Image" description="Select or drag-drop any image. We support PNG, JPG, and WebP formats up to 10MB." />
              <Step number={2} title="AI Analysis & Enhancement" description="Our advanced AI instantly analyzes and enhances your image with clarity boost, noise reduction, and color optimization." />
        ...
        <GradientSection>
          <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-3 xs:space-y-4 mb-12 xs:mb-14 sm:mb-16 px-2 xs:px-0">
              ...
              <p className="text-muted-foreground text-sm xs:text-base sm:text-lg font-light max-w-2xl mx-auto">
                Photographers and content creators love ProEnhance
              </p>
            </div>
            <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-5 sm:gap-6">
              <TestimonialCard quote="ProEnhance completely transformed my photo workflow. The quality is exceptional and it's truly free." author="Sarah Chen" role="Photographer" rating={5} />
        ...
        <CTASection
          ...
          description="Join thousands of creators improving their images with ProEnhance. Get started instantly—no signup required."
