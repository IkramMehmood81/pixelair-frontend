  ...
  return (
    <p className="trust-line">
      <span className="trust-item">
        ...
        Images never stored &mdash; processed &amp; discarded instantly
      </span>
      ...
      <span className="trust-sep">&middot;</span>
      <span className="trust-item">No watermark</span>
    </p>
  )
}
...
function HomePageInner() {
  ...
  const handleSamplePhoto = async () => {
    try {
      ...
      const response = await fetch('/sample1-photo.jpg')
  ...
  const copyShareLink = async () => {
    try {
      await navigator.clipboard.writeText('https://www.photogenerate.ai')
      setCopied(true)
      ...
      <main className="flex-1">
          ...
          >
            ...
            <div className="max-w-6xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 w-full">
              ...
              <div className="hero-two-col">
                ...
                {/* RIGHT — Upload zone */}
                <div className="hero-col-right" id="upload-idle">
                  ...
                  {isClient && uploadedFile ? (
                    ...
                    <div className="mt-4">
                      <TrustSignals />
                      <div className="sample-cta-wrap">
                        <button
                          className="sample-cta-btn"
                          type="button"
                          aria-label="Try the enhancer with a sample blurry photo"
                          onClick={handleSamplePhoto}
                          disabled={sampleLoading}
                        >
                          {sampleLoading ? 'Loading sample...' : 'No photo? Try a sample image instead →'}
                        </button>
                      </div>
                    </div>
                  )}
            ...
            <GradientSection id="upload-done">
              <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="share-section">
                  <p className="share-label">Share PhotoGenerate AI</p>
                  <div className="share-buttons">
                    <a
                      className="share-btn share-twitter"
                      href="https://twitter.com/intent/tweet?text=I+just+enhanced+my+photo+for+free+with+AI+%E2%80%94+try+it+yourself%3A&url=https%3A%2F%2Fwww.photogenerate.ai"
                      target="_blank"
                    ...
                    <a
                      ...
                      href="https://api.whatsapp.com/send?text=I+just+enhanced+my+photo+for+free+with+AI+%E2%80%94+try+it+yourself%3A+https%3A%2F%2Fwww.photogenerate.ai"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      ...
                      href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.photogenerate.ai"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                {/* ── Fix 9: Enhance another (subtle text link) ─────────── */}
                <div className="enhance-again-wrap">
                  <button
                    className="enhance-again-btn"
                    type="button"
                    onClick={handleEnhanceAnother}
                    aria-label="Enhance another photo"
                  >
                    ↩ Enhance Another Photo
                  </button>
                </div>
                ...
                {/* ── Fix 9: Upgrade nudge ──────────────────────────────── */}
                <p className="upgrade-nudge">
                  Want higher resolution output or batch processing?{' '}
                  <a
                    className="upgrade-link"
                    href="mailto:hello@photogenerate.ai?subject=Pro plan inquiry"
                    aria-label="Enquire about Pro plans"
                  >
                    See Pro plans
                  </a>
                </p>
        ...
        {showSections && (
          <>
            ...
            <GradientSection>
              <div className="max-w-5xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
                <div className="text-center px-2 xs:px-0" style={{ marginBottom: 'clamp(2rem, 4vw, 3rem)' }}>
                  <h2
                    className="font-bold text-foreground tracking-tight"
                    style={{ fontSize: 'clamp(1.6rem, 4vw, 3rem)' }}
                  >
                  ...
                  <p
                    ...
                    style={{ fontSize: 'clamp(0.875rem, 1.8vw, 1.125rem)' }}
                  >
                    Drag the slider on any photo to compare before and after AI enhancement
                  </p>
                </div>
                  ...
                  <div className="example-item">
                    <div className="rounded-xl overflow-hidden border border-border shadow-lg">
                      <ComparisonSlider
                        ...
                        beforeLabel="Original (blurry)"
                        afterLabel="AI Enhanced (sharp)"
                        beforeAlt="Blurry portrait photo — before AI enhancement"
                        afterAlt="Sharp portrait photo — after AI enhancement by PhotoGenerate AI"
                      />
                    </div>
                    <p className="example-label">Blurry Portrait</p>
                  </div>
                  <div className="example-item">
                    <div className="rounded-xl overflow-hidden border border-border shadow-lg">
                      <ComparisonSlider
                        beforeImage="old-photo-before.jpg"
                        afterImage="old-photo-after.jpg"
                        beforeLabel="Original (faded)"
                        afterLabel="AI Restored"
                        beforeAlt="Faded old family photo — before AI enhancement"
                        afterAlt="Restored old family photo — after AI enhancement by PhotoGenerate AI"
                      />
                    </div>
                    <p className="example-label">Old Family Photo</p>
                  </div>
                  <div className="example-item">
                    <div className="rounded-xl overflow-hidden border border-border shadow-lg">
                      <ComparisonSlider
                        beforeImage="product-before.jpg"
                        afterImage="product-after.jpg"
                        beforeLabel="Original (low-res)"
                        afterLabel="AI Enhanced"
                        beforeAlt="Blurry product shot — before AI enhancement"
                        afterAlt="Sharp product shot — after AI enhancement by PhotoGenerate AI"
                      />
                    </div>
                    <p className="example-label">Product Shot</p>
                  </div>
                  <div className="example-item">
                    <div className="rounded-xl overflow-hidden border border-border shadow-lg">
                      <ComparisonSlider
                        beforeImage="lowlight-before.jpg"
                        afterImage="lowlight-after.jpg"
                        beforeLabel="Original (dark)"
                        afterLabel="AI Enhanced"
                        beforeAlt="Low-light photo — before AI enhancement"
                        afterAlt="Clear low-light photo — after AI enhancement by PhotoGenerate AI"
                      />
                    </div>
                    <p className="example-label">Low-Light Photo</p>
                  </div>
                </div>
              </div>
            </GradientSection>
            ...
            {/* ── FAQ — last content before footer (HCI best practice):
                Handles final objections after social proof + CTA.
                Users who didn't convert scroll here for answers,
                then hit the footer links as their next action.
            ─────────────────────────────────────────────────────── */}
            <section id="faq" className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 scroll-mt-20">
              <FAQSection
                title="Frequently Asked Questions"
                description="Everything you need to know about our free AI image enhancer"
                items={[
                  { question: 'Is PhotoGenerate AI really free?',                    answer: 'Yes. PhotoGenerate AI is completely free to use. Upload any photo, enhance it with AI, and download the result — no credit card required, no hidden fees, and no watermark on the downloaded image.' },
                  { question: 'Are my photos stored or saved on your servers?',       answer: 'No. Your photos are never stored. Images are processed entirely in memory and discarded instantly the moment enhancement is complete. We do not save, log, or retain any uploaded images.' },
                  { question: 'Do I need to create an account?',                      answer: 'No account or signup is required. Simply upload your photo directly on the homepage, let the AI enhance it, and download the result. No registration, no email address needed.' },
                  { question: 'Will my enhanced photo have a watermark?',             answer: 'No. Enhanced photos are downloaded completely watermark-free. You own the result and can use it however you like.' },
                  { question: 'What image formats are supported?',                    answer: 'PhotoGenerate AI supports JPG, JPEG, PNG, and WebP image formats. For best results, use a JPG or PNG file under 10MB.' },
                  { question: 'How long does AI photo enhancement take?',             answer: 'Enhancement typically takes 10 to 20 seconds depending on the image size and complexity. You will see a progress indicator while the AI processes your photo.' },
                  { question: 'What types of photos can PhotoGenerate AI improve?',   answer: 'PhotoGenerate AI can improve blurry portraits, old faded family photos, low-resolution product images, grainy night photos, out-of-focus shots, and pixelated images. It works on any photo type — personal, professional, or commercial.' },
                  { question: 'Does PhotoGenerate AI work on mobile phones?',         answer: 'Yes. PhotoGenerate AI works in any modern mobile browser on iOS and Android. You can upload directly from your camera roll without installing any app.' },
                ]}
              />
            </section>
          </>
